...
export async function generateEventConfigFromInputs(
  ...
  const config: EventAppConfig = {
    ...
    ticketing: bamlResult.ticketing ? {
        enabled: bamlResult.ticketing.enabled,
        tiers: bamlResult.ticketing.tiers.map(t => ({
            ...t,
            currency: "USD", // Default currency
            paymentUrl: undefined // BAML doesn't generate this yet
        }))
    } : {
        enabled: false,
        tiers: []
